...
<?php
 if (isset($_SESSION['add-category-success']))  ://shows if add category was successfull  ?>
        ...
        <?php
  elseif (isset($_SESSION['add-category']))  ://shows if add category was not successfull  ?>
    ...
    <div class="container dashboard_container">
        ...
        <aside>
            <ul>
                ...
                <li><a href="manage-catergories.php" class="active"><i class="uil uil-list-ul"></i>
             ...
             <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="<?= ROOT_URL ?>Admin/edit-catergory.php?id=<?= $category['cat_id']?>" class="btn sm">Edit</a></td>
